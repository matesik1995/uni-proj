# Lab 5 Data processing in Databases - bash
## Run:
To run simply type ./run.sh in your terminal. Script assumes that unpacked dataset files are avaliable in working directory
